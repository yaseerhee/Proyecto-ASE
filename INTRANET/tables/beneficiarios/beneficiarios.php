                ...
                <nav class="navbar navbar-inverse bg-primary">
                    <div class="container-fluid">
                        <div class="row" id="enlaces">
                            <button class="btn btn-primary btn-header"><a href="../familias/familia.php" id="enlace-aboutUs">Familias</a></button>
                            <button class="btn btn-primary btn-header"><a href="<?php $_SERVER["PHP_SELF"] ?>" id="enlace-trabajo">Beneficiarios</a></button>
                            <button class="btn btn-primary btn-header"><a href="../voluntarios/voluntarios.php" id="enlace-contacto">Voluntarios</a></button>
                            <form class="row d-flex p-2">
                                <input class="col-8 form-control mr-sm-2" type="text" placeholder="Busca a la familia... ">
                                <button class="col-3 btn btn-secondary my-2 my-sm-0" type="submit">Buscar</button>
                            </form>
                        </div>
                    </div>
                </nav>
