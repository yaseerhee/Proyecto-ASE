                ...
                <nav class="navbar navbar-inverse bg-primary">
                    <div class="container-fluid">
                        <div class="row" id="enlaces">
                            <button class="btn btn-primary btn-header"><a href="familia.php" id="enlace-aboutUs">Familias</a></button>
                            <button class="btn btn-primary btn-header"><a href="beneficiarios.php" id="enlace-trabajo">Beneficiarios</a></button>
                            <button class="btn btn-primary btn-header"><a href="<?php $_SERVER["PHP_SELF"] ?>" id="enlace-contacto">Voluntarios</a></button>
                        </div>
                    </div>
                </nav>
            </nav>
